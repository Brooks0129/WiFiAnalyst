...
public class ChartActivity extends AppCompatActivity {
    ...
    private void setData() {
        t1.setText("最小rtt:"+yanchi.get(0)+ "ms");
        t2.setText("平均rtt:"+yanchi.get(1)+ "ms");
        t3.setText("最大rtt:"+yanchi.get(2)+ "ms");
        t4.setText("rtt算数平均偏差:"+yanchi.get(3)+ "ms");
    }
...
//      line.setHasLabelsOnlyForSelected(true);//点击数据坐标提示数据（设置了这个line.setHasLabels(true);就无效）
    ...
    public void getData() {
        ...
        yanchi = bundle.getStringArrayList("yanchi");
    }
}