...
public class LostActivity extends AppCompatActivity implements AMapLocationListener{
    ...
    private Button bt_lost;
    private Button bt_upload;
    String URL="www.baidu.com";
    String URL2="10.11.252.1";
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        rb_ip.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            ...
            public void onCheckedChanged(CompoundButton buttonView,
                                         boolean isChecked){
                et_ip.setVisibility(isChecked == true
                        ? View.VISIBLE
                        :View.GONE);
            }
        });
        ...
        bt_lost.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                progressDialog.setMessage("正在执行ping " + URL + "命令...");
        ...
        handler=new Handler(){
            ...
            public void handleMessage(Message msg){
                ...
                ArrayList<String> yanchi=data.getStringArrayList("yanchi");
    ...
    private void testLost(){
        ...
        Process p=null;
        try {
            p=Runtime.getRuntime().exec("ping -c 20 " + URL);
        ...
        final ArrayList<String> listDouDong=new ArrayList<String>();
        try {
    ...
    public void onLocationChanged(final AMapLocation aMapLocation){
        if (aMapLocation != null) if (aMapLocation.getErrorCode() == 0) {
            ...
            //  Log.d("精度信息",String.valueOf(aMapLocation.getAccuracy()));
            ...
            final String date=df.format(new Date(aMapLocation.getTime()));//定位时间
            bt_upload.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v){
                    ...
                    new AlertDialog.Builder(LostActivity.this).setTitle("请对您的网络状况进行打分")
                        ...
                        public void onClick(DialogInterface dialog,int which){
                            ...
                            new AlertDialog.Builder(LostActivity.this).setTitle("选择地址")
                                ...
                                public void onClick(DialogInterface dialog,int which){
                                    ...
                                    progressDialog.setCancelable(true);
                                    progressDialog.show();
                                    wifi.save(LostActivity.this,new SaveListener(){
                                        @Override
                                        public void onSuccess(){
                                            progressDialog.dismiss();
                                            Toast.makeText(LostActivity.this,"数据上传成功",Toast.LENGTH_SHORT).show();
                                        }
                                        @Override
                                        public void onFailure(int code,String arg0){
                                            progressDialog.dismiss();
                                            // 添加失败
                                            Toast.makeText(LostActivity.this,"数据上传失败",Toast.LENGTH_SHORT).show();
                                        }
                                    });
                                }
                            }).create().show();
